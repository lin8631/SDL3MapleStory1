...
void WorldMap::show(std::u16string path)
{
    ...
    auto base_w = WorldMap::baseimg.spr.sprw->texture->w;
    auto base_h = WorldMap::baseimg.spr.sprw->texture->h;
    float bg_w = base_w + 12.0f;
    float bg_h = base_h + 44.0f;
...
void WorldMap::load_backgrnd()
{
    ...
    auto base_w = WorldMap::baseimg.spr.sprw->texture->w;
    auto base_h = WorldMap::baseimg.spr.sprw->texture->h;
    auto width = base_w + 12;
    auto height = base_h + 44;
